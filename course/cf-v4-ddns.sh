...
# 填写Global API Key,获取 https://dash.cloudflare.com/profile/api-tokens 
CFKEY=

# Username, eg: user@example.com 填写登陆CF的邮箱
CFUSER=

# Zone name, eg: example.com 填写根域名
CFZONE_NAME=

# Hostname to update, eg: homeserver.example.com 填写子域名前缀,如a.example.com则填写a
CFRECORD_NAME=
